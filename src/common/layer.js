 ...
 *
 * @example
 * l1 = new Layer('name', group); // Use the existing group for this layer.
 * l2 = new Layer('name', group, svgElem); // Create a new group and add it to the DOM after group.
 * l3 = new Layer('name', null, svgElem); // Create a new group and add it to the DOM as the last layer.
