export default {
  ...
  notification: {
    ...
    clipboardDefsConflict: 'The pasted content references definitions whose IDs already exist with different content. Conflicting IDs: {{ids}}. Choose how to resolve all conflicts. Replacing existing definitions can change elements already in this drawing.',
    clipboardUseExisting: 'Use existing',
    clipboardReplaceExisting: 'Replace existing',
    clipboardKeepBoth: 'Keep both',
