 ...
 */
export class SvgExplorerButton extends HTMLElement {
  /**
  ...
  async updateLib (menu) {
    ...
    try {
      ...
      console.error(`could not read file:${libDir}${menu}.json`, error)
    }
  }
}

// Register
customElements.define('se-svgexplorerbutton', SvgExplorerButton)
