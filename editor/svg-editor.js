...
$(document).ready(function(){
	var canvas = new SvgCanvas(document.getElementById("svgcanvas"));
	...
	$('#stroke_width').change(function(){
		canvas.setStrokeWidth(this.options[this.selectedIndex].value);
	});

	$('#stroke_style').change(function(){
		canvas.setStrokeStyle(this.options[this.selectedIndex].value);
	});

	$('#stroke_opacity').change(function(){
		canvas.setStrokeOpacity(this.options[this.selectedIndex].value);
	});

	$('#fill_opacity').change(function(){
		canvas.setFillOpacity(this.options[this.selectedIndex].value);
	});

	$('#group_opacity').change(function(){
		canvas.setOpacity(this.options[this.selectedIndex].value);
	});
	...
	$('#tool_fhellipse').click(function(){
		toolButtonClick('#tools_ellipse_show');
		canvas.setMode('fhellipse');
	});

	$('#tool_delete').click(function(){
		toolButtonClick(this);
		canvas.setMode('delete');
	});
	...
	var colorPicker = function(elem) {
		...
		$('#color_picker').css({'left': pos.left, 'top': pos.top}).jPicker({
			...
			if (elem.attr('id') == 'stroke_color') {
				canvas.setStrokeColor('#' + this.settings.color.active.hex);
			} else if (elem.attr('id') == 'fill_color') {
				canvas.setFillColor('#' + this.settings.color.active.hex);
			}
			$('#color_picker').hide();
		}
		, null, function(){
