...
//   CREATE A NEW FILE ../svgedit-config.js AND ADD CONTENTS
//   SUCH AS SHOWN BELOW INTO THAT FILE.

/*globals svgEditor*/
/*
The svgedit-config.js file is intended for the setting of configuration or
...
svgEditor.setConfig({
	...
	// , noDefaultExtensions: false, // noDefaultExtensions can only be meaningfully used in svgedit-config.js or in the URL
});
