svgEditor.readLang({
	...
	ui: {
		...
		"panel_drag": "Glisser gauche/droite pour changer la taille"
	},
	properties: {
		...
		"stroke_width": "Changer la largeur du contour de 1, maj-Click pour changer la largeur de 0.1",
	...
	tools: { 
		...
		"clone": "Cloner à l'infini",
		"del": "Supprimer l'élément",
		"group": "Grouper les éléments",
		"make_link": "Créer un hyperlien",
		"set_link_url": "Modifier l'URL (laisser vide pour supprimer)",
	...
	layers: {
		...
		"dupe": "Cloner le calque",
		"merge_down": "Fusionner avec le calque inférieur",
	...
	imagelib: {
		...
		"show_list": "Liste de la bibliothèque",
		"import_single": "Importation simple",
		"import_multi": "Importation multiple",
		"open": "Ouvrir comme nouveau document"
	},
	notification: {
		...
		"enterNewLinkURL": "Entrer le nouvel hyperlien",
