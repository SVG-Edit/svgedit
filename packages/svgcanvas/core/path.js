...
import { init as pathActionsInit, pathActionsMethod } from './path-actions.js'
...
export const init = canvas => {
  ...
  svgCanvas.getSegData = () => {
    return segData
  }
  svgCanvas.getPathObj = () => {
    return path
  }
  svgCanvas.setPathObj = obj => {
    path = obj
  }
  svgCanvas.getPathFuncs = () => {
    return pathFuncs
  }
  svgCanvas.getLinkControlPts = () => {
...
export const smoothControlPoints = (ct1, ct2, pt) => {
  ...
  if ((x1 !== 0 || y1 !== 0) && (x2 !== 0 || y2 !== 0)) {
    ...
    const nct1 = svgCanvas.svgRoot.createSVGPoint()
    const nct2 = svgCanvas.svgRoot.createSVGPoint()
