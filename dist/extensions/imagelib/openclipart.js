(function () {
  ...
  */
  ...
  function _optsOrUndefinedJML() {
      ...
      return jml.apply(undefined, toConsumableArray$1(args[0] === undefined ? args.slice(1) : args));
  }
  ...
  */
  function _childrenToJML(node) {
      return function (childNodeJML, i) {
          ...
          var j = Array.isArray(childNodeJML) ? jml.apply(undefined, toConsumableArray$1(childNodeJML)) : jml(childNodeJML);
  ...
  */
  function _appendJML(node) {
      return function (childJML) {
          node.appendChild(jml.apply(undefined, toConsumableArray$1(childJML)));
      };
  }
  ...
  */
  ...
  var jml = function jml() {
              ...
              switch (att) {
                  ...
                  */
                  case '#':
                          ...
                          if (template) {
                              if (Array.isArray(template)) {
                                  if (_getType(template[0]) === 'object') {
                                      // Has attributes
                                      template = jml.apply(undefined, ['template'].concat(toConsumableArray$1(template), [doc.body]));
                                  } else {
                          ...
                          var _ret = function () {
                              ...
                              var getConstructor = function getConstructor(cb) {
                                  ...
                                  return cb ? function (_baseClass) {
                                      ...
                                      inherits$1(_class2, _baseClass2);

                                      function _class2() {
                                          classCallCheck$1(this, _class2);
                                          return possibleConstructorReturn$1(this, (_class2.__proto__ || Object.getPrototypeOf(_class2)).apply(this, arguments));
                                      }
                              ...
                              if (Array.isArray(attVal)) {
                                  if (attVal.length <= 2) {
                                      var _attVal = slicedToArray$1(attVal, 2);
                                      ...
                                      var _attVal2 = slicedToArray$1(attVal, 3);
                      ...
                      {
                          var _attVal3 = slicedToArray$1(attVal, 2),
                              symbol = _attVal3[0],
                              func = _attVal3[1];
      ...
      var setMap = function setMap(dataVal) {
          ...
          if (dataVal === true) {
              var _defaultMap = slicedToArray$1(defaultMap, 2);
                      ...
                      switch (childContentType) {
                          ...
                          default:
                              if (Array.isArray(childContent)) {
                                  ...
                                  _appendNode(elem, _optsOrUndefinedJML.apply(undefined, [opts].concat(toConsumableArray$1(childContent))));
  ...
  */
  ...
  var JamilihMap = function (_Map) {
      inherits$1(JamilihMap, _Map);

      function JamilihMap() {
          classCallCheck$1(this, JamilihMap);
          return possibleConstructorReturn$1(this, (JamilihMap.__proto__ || Object.getPrototypeOf(JamilihMap)).apply(this, arguments));
      }

      createClass$1(JamilihMap, [{
          key: 'get',
          value: function get$$1(elem) {
              elem = typeof elem === 'string' ? $(elem) : elem;
              return get$1(JamilihMap.prototype.__proto__ || Object.getPrototypeOf(JamilihMap.prototype), 'get', this).call(this, elem);
          }
      }, {
          key: 'set',
          value: function set$$1(elem, value) {
              elem = typeof elem === 'string' ? $(elem) : elem;
              return get$1(JamilihMap.prototype.__proto__ || Object.getPrototypeOf(JamilihMap.prototype), 'set', this).call(this, elem, value);
          }
      }, {
          key: 'invoke',
  ...
  var JamilihWeakMap = function (_WeakMap) {
      inherits$1(JamilihWeakMap, _WeakMap);

      function JamilihWeakMap() {
          classCallCheck$1(this, JamilihWeakMap);
          return possibleConstructorReturn$1(this, (JamilihWeakMap.__proto__ || Object.getPrototypeOf(JamilihWeakMap)).apply(this, arguments));
      }

      createClass$1(JamilihWeakMap, [{
          key: 'get',
          value: function get$$1(elem) {
              elem = typeof elem === 'string' ? $(elem) : elem;
              return get$1(JamilihWeakMap.prototype.__proto__ || Object.getPrototypeOf(JamilihWeakMap.prototype), 'get', this).call(this, elem);
          }
      }, {
          key: 'set',
          value: function set$$1(elem, value) {
              elem = typeof elem === 'string' ? $(elem) : elem;
              return get$1(JamilihWeakMap.prototype.__proto__ || Object.getPrototypeOf(JamilihWeakMap.prototype), 'set', this).call(this, elem, value);
          }
      }, {
          key: 'invoke',
          value: function invoke(elem, methodName) {
  ...
  var QueryResult = function (_extendableBuiltin2) {
    inherits(QueryResult, _extendableBuiltin2);

    function QueryResult() {
      classCallCheck(this, QueryResult);
      return possibleConstructorReturn(this, (QueryResult.__proto__ || Object.getPrototypeOf(QueryResult)).apply(this, arguments));
    }
  ...
  var search = function search(list, el) {
    ...
    return new (Function.prototype.bind.apply(QueryResult, [null].concat(nodes)))();
  };
  var defineProperty$1 = Object.defineProperty;

  var $$1 = defineProperty$1(function (CSS) {
    var parent = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : document;

    switch (typeof CSS === 'undefined' ? 'undefined' : _typeof(CSS)) {
      case 'string':
        return search(CSS.split(','), parent);
      case 'object':
        return new (Function.prototype.bind.apply(QueryResult, [null].concat(toConsumableArray('nodeType' in CSS || 'postMessage' in CSS ? [CSS] : CSS))))();
      case 'function':
        var $parent = $$1(parent);
  ...
  }, Symbol.hasInstance, { value: function value(instance) {
      return instance instanceof QueryResult;
    } });
  $$1.extend = function (key, value) {
    return defineProperty$1(QueryResult.prototype, key, { configurable: true, value: value }), $$1;
  };
  ...
  function convertToString(type, content) {
    switch (typeof content === 'undefined' ? 'undefined' : _typeof(content)) {
            ...
            case 11:
              {
                ...
                return [].concat(toConsumableArray(content.childNodes)).reduce(function (s, node) {
      ...
      default:
        throw new TypeError('Bad content for ' + type + '; type: ' + (typeof content === 'undefined' ? 'undefined' : _typeof(content)));
    }
  }
        ...
        default:
          {
            this.forEach(function (node) {
              node[type].apply(node, toConsumableArray(args.map(function (content, i) {
  ...
  var methods = { after: after, before: before, append: append, prepend: prepend, html: html, text: text };
    ...
    if (jml) {
      $.extend('jml', function () {
        ...
        this.forEach(function (node) {
          ...
          var n = jml.apply(undefined, args);
          return append.call(_this3, n);
        });
      });
    }
    return $;
  ...
  var processResults = function () {
    var _ref = asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(url) {
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 11:
              ...
              $$1('#results').jml('div', [['span', ['Number of results: ', numResults]], semiColonSep, ['span', ['page ', currentPage, ' out of ', pages]]].concat(toConsumableArray(payload.map(function (_ref2) {
                var title = _ref2.title,
                    description = _ref2.description,
                    id = _ref2.id,
                    uploader = _ref2.uploader,
                    created = _ref2.created,
                    svgURL = _ref2.svg.url,
                    detailLink = _ref2.detail_link,
                    tagsArray = _ref2.tags_array,
                    downloadedBy = _ref2.downloaded_by,
                    totalFavorites = _ref2.total_favorites;
                ...
                return ['div', [['button', { style: 'margin-right: 8px; border: 2px solid black;', dataset: { id: id, value: svgURL }, $on: {
                  ...
                  href: detailLink,
                  target: '_blank'
                }, ['Details']]]], ['br'], ['span', [['u', ['Uploaded by']], colonSep, queryLink(uploader), semiColonSep]], ['span', [['u', ['Download count']], colonSep, downloadedBy, semiColonSep]], ['span', [['u', ['Times used as favorite']], colonSep, totalFavorites, semiColonSep]], ['span', [['u', ['Created date']], colonSep, created]], ['br'], ['u', ['Tags']], colonSep].concat(toConsumableArray(tagsArray.map(function (tag) {
    ...
    return function processResults(_x) {
  ...
  // Todo: i18nize
  ['fieldset', [['legend', ['Search terms']], ['div', { class: 'control' }, [['label', ['Query (Title, description, uploader, or tag): ', ['input', { id: 'query', name: 'query', placeholder: 'cat', $custom: {
    ...
    } }]]]]], ['br'], ' OR ', ['br'], ['div', { class: 'control' }, [['label', ['IDs (single or comma-separated): ', ['input', { id: 'byids', name: 'ids', placeholder: '271380, 265741', $custom: {
      $set: function $set(value) {
        $$1('#query')[0].value = '';
        this.value = value;
      }
    ...
    } }]]]]]]], ['fieldset', [['legend', ['Configuring results']], ['div', { class: 'control' }, [['label', ['Sort by: ', ['select', { id: 'sort' }, [
  // Todo: i18nize first values
  ['Date', 'date'], ['Downloads', 'downloads'], ['Favorited', 'favorites']].map(function (_ref5) {
    var _ref6 = slicedToArray(_ref5, 2),
        text$$1 = _ref6[0],
        _ref6$ = _ref6[1],
        value = _ref6$ === undefined ? text$$1 : _ref6$;

    return ['option', { value: value }, [text$$1]];
  })]]]]], ['div', { class: 'control' }, [['label', ['Results per page: ', ['input', {
    id: 'amount', name: 'amount', value: 10,
    type: 'number', min: 1, max: 200, step: 1, pattern: '\\d+' }]]]]], ['div', { class: 'control' }, [['label', ['Page number: ', ['input', {
  ...
  }]]]]]]], ['div', { class: 'control' }, [['input', { type: 'submit' }]]]]], ['div', { id: 'results' }]], body);
